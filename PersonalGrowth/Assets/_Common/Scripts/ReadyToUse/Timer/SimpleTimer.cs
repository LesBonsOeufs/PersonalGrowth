...
public class SimpleTimer : MonoBehaviour
{
	...
	[ProgressBar("TimeLeft", "duration", EColor.Red), SerializeField] float currentTime = 2f;
	...
	[Header("Audio")]
	[SerializeField] private MMF_Player tickFeedback = default;
